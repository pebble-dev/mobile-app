...
class FakeDeviceCalendarPlugin implements DeviceCalendarPlugin {
  ...
  @override
  Future<Result<String>> createCalendar(String? calendarName, {Color? calendarColor, String? localAccountName}) {
    throw UnimplementedError("Not supported for tests yet");
  }
  ...
  @override
  Future<Result<bool>> deleteCalendar(String calendarId) {
    throw UnimplementedError("Not supported for tests yet");
  }
  ...
  @override
  Future<Result<bool>> deleteEventInstance(String? calendarId, String? eventId, int? startDate, int? endDate, bool deleteFollowingInstances) {
    throw UnimplementedError("Not supported for tests yet");
  }

  @override
  Future<Result<UnmodifiableListView<Event>>> retrieveEvents(String? calendarId, RetrieveEventsParams? retrieveEventsParams) {
  ...
  @override
  Future<Result<void>> showiOSEventModal(String eventId) {
    throw UnimplementedError("Not supported for tests yet");
  }
}
