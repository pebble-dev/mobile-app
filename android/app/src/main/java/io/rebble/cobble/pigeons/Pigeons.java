...
public class Pigeons {
  ...
  public static class StringWrapper {
    ...
    static StringWrapper fromMap(Map<String, Object> map) {
  ...
  public static class BooleanWrapper {
    ...
    static BooleanWrapper fromMap(Map<String, Object> map) {
  ...
  public static class NumberWrapper {
    ...
    static NumberWrapper fromMap(Map<String, Object> map) {
  ...
  public static class TimelinePinPigeon {
    ...
    static TimelinePinPigeon fromMap(Map<String, Object> map) {
  ...
  public static class ListWrapper {
    ...
    public void setValue(List<Object> setterArg) { this.value = setterArg; }
    ...
    static ListWrapper fromMap(Map<String, Object> map) {
      ListWrapper fromMapResult = new ListWrapper();
      Object value = map.get("value");
      fromMapResult.value = (List<Object>)value;
      return fromMapResult;
    }
  }
  ...
  public static class PebbleScanDevicePigeon {
    ...
    static PebbleScanDevicePigeon fromMap(Map<String, Object> map) {
  ...
  public static class WatchConnectionStatePigeon {
    ...
    public void setIsEmulator(Boolean setterArg) { this.isEmulator = setterArg; }
    ...
    static WatchConnectionStatePigeon fromMap(Map<String, Object> map) {
      ...
      Object isEmulator = map.get("isEmulator");
      fromMapResult.isEmulator = (Boolean)isEmulator;
      ...
      fromMapResult.currentConnectedWatch = PebbleDevicePigeon.fromMap((Map)currentConnectedWatch);
      return fromMapResult;
    }
  }
  ...
  public static class PebbleDevicePigeon {
    ...
    static PebbleDevicePigeon fromMap(Map<String, Object> map) {
      ...
      fromMapResult.runningFirmware = PebbleFirmwarePigeon.fromMap((Map)runningFirmware);
      Object recoveryFirmware = map.get("recoveryFirmware");
      fromMapResult.recoveryFirmware = PebbleFirmwarePigeon.fromMap((Map)recoveryFirmware);
  ...
  public static class PebbleFirmwarePigeon {
    ...
    static PebbleFirmwarePigeon fromMap(Map<String, Object> map) {
  ...
  public static class ActionResponsePigeon {
    ...
    static ActionResponsePigeon fromMap(Map<String, Object> map) {
  ...
  public static class ActionTrigger {
    ...
    static ActionTrigger fromMap(Map<String, Object> map) {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class EmulatorConnectionPigeon {
    private String host;
    public String getHost() { return host; }
    public void setHost(String setterArg) { this.host = setterArg; }
    ...
    static EmulatorConnectionPigeon fromMap(Map<String, Object> map) {
      EmulatorConnectionPigeon fromMapResult = new EmulatorConnectionPigeon();
      Object host = map.get("host");
      fromMapResult.host = (String)host;
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              StringWrapper input = StringWrapper.fromMap((Map<String, Object>)message);
              api.v(input);
    ...
    static void setup(BinaryMessenger binaryMessenger, TimelineControl api) {
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              TimelinePinPigeon input = TimelinePinPigeon.fromMap((Map<String, Object>)message);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              ListWrapper input = ListWrapper.fromMap((Map<String, Object>)message);
    ...
    static void setup(BinaryMessenger binaryMessenger, BackgroundSetupControl api) {
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              NumberWrapper input = NumberWrapper.fromMap((Map<String, Object>)message);
  ...
  public static class ScanCallbacks {
    ...
    public void onScanUpdate(ListWrapper argInput, Reply<Void> callback) {
      ...
      if (callback != null){
        ...
        channel.send(inputMap, null);
      }
    }
    public void onScanUpdate(ListWrapper argInput) {
      onScanUpdate(argInput, null);
    }
    ...
    static void setup(BinaryMessenger binaryMessenger, KeepUnusedHack api) {
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              PebbleScanDevicePigeon input = PebbleScanDevicePigeon.fromMap((Map<String, Object>)message);
  ...
  public static class PairCallbacks {
    ...
    public void onWatchPairComplete(NumberWrapper argInput) {
      onWatchPairComplete(argInput, null);
    }
  }
  ...
  public static class ConnectionCallbacks {
    ...
    public void onWatchConnectionStateChanged(WatchConnectionStatePigeon argInput) {
      onWatchConnectionStateChanged(argInput, null);
    }
  }
  ...
  public static class TimelineCallbacks {
    ...
    public void syncTimelineToWatch() {
      syncTimelineToWatch(null);
    }
    ...
    public void handleTimelineAction(ActionTrigger argInput) {
      handleTimelineAction(argInput, null);
    }
  }
  ...
  public static class CalendarCallbacks {
    ...
    public void doFullCalendarSync() {
      doFullCalendarSync(null);
    }
    ...
    public void deleteCalendarPinsFromWatch() {
      deleteCalendarPinsFromWatch(null);
    }
  }
  ...
  public interface UiConnectionControl {
    ...
    void connectToEmulator(EmulatorConnectionPigeon arg);
    ...
    static void setup(BinaryMessenger binaryMessenger, UiConnectionControl api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.UiConnectionControl.connectToEmulator", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              EmulatorConnectionPigeon input = EmulatorConnectionPigeon.fromMap((Map<String, Object>)message);
              api.connectToEmulator(input);
              wrapped.put("result", null);
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
