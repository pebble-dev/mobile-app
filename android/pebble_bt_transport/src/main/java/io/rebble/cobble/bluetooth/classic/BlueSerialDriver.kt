...
class BlueSerialDriver(
    ...
    override fun startSingleWatchConnection(device: PebbleDevice): Flow<SingleConnectionStatus> = flow<SingleConnectionStatus> {
        ...
        val sendLoop = device.negotiationScope.launch(CoroutineName("SendLoop")) {
