...
- (void)handleTimelineActionActionTrigger:(nullable ActionTrigger *)actionTrigger completion:(void(^)(ActionResponsePigeon *, NSError *_Nullable))completion;
@end
...
- (void)beginAppOrderChangeAppReorderRequest:(nullable AppReorderRequest *)appReorderRequest completion:(void(^)(NSError *_Nullable))completion;
@end
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)handleNotificationNotification:(nullable NotificationPigeon *)notification completion:(void(^)(TimelinePinPigeon *, NSError *_Nullable))completion;
...
- (void)deleteCalendarPinsFromWatchWithError:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)beginAppOrderChangeAppReorderRequest:(nullable AppReorderRequest *)appReorderRequest completion:(void(^)(NumberWrapper *_Nullable, FlutterError *_Nullable))completion;
