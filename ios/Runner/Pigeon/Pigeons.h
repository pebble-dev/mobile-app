...
- (void)handleTimelineActionActionTrigger:(ActionTrigger *)actionTrigger completion:(void(^)(ActionResponsePigeon *_Nullable, NSError *_Nullable))completion;
@end
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)beginAppInstallInstallData:(InstallData *)installData completion:(void(^)(NSError *_Nullable))completion;
- (void)deleteAppUuid:(StringWrapper *)uuid completion:(void(^)(NSError *_Nullable))completion;
@end
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)handleNotificationNotification:(NotificationPigeon *)notification completion:(void(^)(TimelinePinPigeon *_Nullable, NSError *_Nullable))completion;
- (void)dismissNotificationItemId:(StringWrapper *)itemId completion:(void(^)(NSError *_Nullable))completion;
- (void)shouldNotifyChannel:(NotifChannelPigeon *)channel completion:(void(^)(BooleanWrapper *_Nullable, NSError *_Nullable))completion;
