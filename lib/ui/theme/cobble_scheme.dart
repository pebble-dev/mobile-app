...
class CobbleSchemeTextData {
  ...
  CobbleSchemeTextData({
    @required this.text,
    @required this.muted,
    @required this.divider,
  });

  static final _textOnLight = CobbleSchemeTextData(
  ...
  factory CobbleSchemeTextData.fromBrightness(Brightness brightness) =>
      brightness == Brightness.light ? _textOnLight : _textOnDark;
}
...
class CobbleSchemeData {
  ...
  final CobbleSchemeTextData text;
  ...
  static final _darkScheme = CobbleSchemeData(
    ...
    text: CobbleSchemeTextData.fromBrightness(Brightness.dark),
  );
