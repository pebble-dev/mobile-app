...
abstract class CalendarCallbacks {
  ...
  static void setup(CalendarCallbacks? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.CalendarCallbacks.deleteCalendarPinsFromWatch', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
    ...
    } else 
{
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:       
        return AppReorderRequest.decode(readValue(buffer)!);
...
abstract class BackgroundAppInstallCallbacks {
  ...
  Future<void> beginAppOrderChange(AppReorderRequest appReorderRequest);
  static void setup(BackgroundAppInstallCallbacks? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.BackgroundAppInstallCallbacks.beginAppOrderChange', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.BackgroundAppInstallCallbacks.beginAppOrderChange was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final AppReorderRequest? arg_appReorderRequest = (args[0] as AppReorderRequest?);
          assert(arg_appReorderRequest != null, 'Argument for dev.flutter.pigeon.BackgroundAppInstallCallbacks.beginAppOrderChange was null, expected non-null AppReorderRequest.');
          await api.beginAppOrderChange(arg_appReorderRequest!);
          return;
        });
      }
    }
...
class CalendarControl {
  ...
  Future<void> deleteCalendarPinsFromWatch() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CalendarControl.deleteCalendarPinsFromWatch', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(null) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
...
class AppInstallControl {
  ...
  Future<NumberWrapper> beginAppOrderChange(AppReorderRequest arg_appReorderRequest) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AppInstallControl.beginAppOrderChange', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object>[arg_appReorderRequest]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
