...
class WatchConnectionStatePigeon {
  ...
  Map<dynamic, dynamic> _toMap() {
    ...
    pigeonMap['isEmulator'] = isEmulator;
  ...
  static WatchConnectionStatePigeon _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.isEmulator = pigeonMap['isEmulator'];
    result.currentWatchAddress = pigeonMap['currentWatchAddress'];
    result.currentConnectedWatch = PebbleDevicePigeon._fromMap(pigeonMap['currentConnectedWatch']);
    return result;
  }
}
...
class PebbleDevicePigeon {
  ...
  static PebbleDevicePigeon _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.name = pigeonMap['name'];
    result.address = pigeonMap['address'];
    result.runningFirmware = PebbleFirmwarePigeon._fromMap(pigeonMap['runningFirmware']);
    result.recoveryFirmware = PebbleFirmwarePigeon._fromMap(pigeonMap['recoveryFirmware']);
...
class EmulatorConnectionPigeon {
  ...
  // ignore: unused_element
  static EmulatorConnectionPigeon _fromMap(Map<dynamic, dynamic> pigeonMap) {
    if (pigeonMap == null){
      return null;
    }
    final EmulatorConnectionPigeon result = EmulatorConnectionPigeon();
    result.host = pigeonMap['host'];
...
class UiConnectionControl {
  ...
  Future<void> connectToEmulator(EmulatorConnectionPigeon arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.UiConnectionControl.connectToEmulator', StandardMessageCodec());
