...
class PebbleWatchColor { // Defining colors used for different Pebble models
  ...
  static const Color White = Color(0xFFFFFFFF); // Body color for white classic/P2
  static const Color Grey = Color(0xFF999999); // Body color for grey classic
  static const Color Orange = Color(0xFFFA8921); // Body color for orange classic
  static const Color HotPink = Color(0xFFFF60A3); // They sure made a lot of these huh
  static const Color FreshGreen = Color(0xFFC7EC42); // Body color for green classics
  static const Color FlyBlue = Color(0xFF03E0FF); // Body color for blue classics

  static const Color Silver = Color(0xFFC4C4C4); // Body color for silver watches
  static const Color Gold = Color(0xFFECC284); // Body color for gold time steel
  static const Color RoseGold = Color(0xFFD7A17F); // Body stroke color for gold time round

  static const Color Turquoise = Color(0xFF3B8E94); // Button+screen stroke for turq/white P2HR
  static const Color Flame = Color(0xFFE03A3A); // Button color for red/black P2HR
  static const Color Lime = Color(0xFFBFE051); // Button color for green/black P2HR
}